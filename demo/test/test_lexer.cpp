...
void tast_body(candy_tokens_t token, const char code[], supposed ... value) {
  ...
  if constexpr(sizeof...(value)) {
    ...
    if constexpr (std::is_same<decltype(val), string_view>::value) {
...
TEST_LEXER(integer_0, CANDY_TK_CST_INTEGER,    "114514",    114514);
TEST_LEXER(integer_1, CANDY_TK_CST_INTEGER,   "+114514",   +114514);
TEST_LEXER(integer_2, CANDY_TK_CST_INTEGER,   "-114514",   -114514);
TEST_LEXER(hex_0,     CANDY_TK_CST_INTEGER,  "0x114514",  0x114514);
TEST_LEXER(hex_1,     CANDY_TK_CST_INTEGER, "+0x114514", +0x114514);
TEST_LEXER(hex_2,     CANDY_TK_CST_INTEGER, "-0x114514", -0x114514);

TEST_LEXER(float_0, CANDY_TK_CST_FLOAT,      "3.1415926",     3.1415926);
TEST_LEXER(float_1, CANDY_TK_CST_FLOAT,     "+3.1415926",    +3.1415926);
TEST_LEXER(float_2, CANDY_TK_CST_FLOAT,     "-3.1415926",    -3.1415926);
TEST_LEXER(sci_0,   CANDY_TK_CST_FLOAT,   "0.31415926e1",  0.31415926e1);
TEST_LEXER(sci_1,   CANDY_TK_CST_FLOAT,  "+0.31415926e1", +0.31415926e1);
TEST_LEXER(sci_2,   CANDY_TK_CST_FLOAT,  "-0.31415926e1", -0.31415926e1);
TEST_LEXER(sci_3,   CANDY_TK_CST_FLOAT,   "314.15926e-2",  314.15926e-2);
TEST_LEXER(sci_4,   CANDY_TK_CST_FLOAT,  "+314.15926e-2", +314.15926e-2);
TEST_LEXER(sci_5,   CANDY_TK_CST_FLOAT,  "-314.15926e-2", -314.15926e-2);
